...
class DuibaBaseHandler(WebBaseHandler):
    """ 兑吧基础类 """
...
class ConsumeHandler(DuibaBaseHandler):
    ...
    def get(self):
       ...
       # address = ''
        ...
        #address = params[add] if params[add] else address
        #self.write(params['params'])
        #self.write_json(params['params'])
        ...
        utils.loggers.use('duiba', log_path).info(params['credits']) 
